            ...
            <div className="container">
              ...
              <div className="navbar-collapse collapse col-md-8">
                <ul className="nav navbar-nav navbar-right">
                  <li>
                    <NavLink to={'/about'} style={{ cursor: "pointer" }} activeClassName="isSelectedActive" onClick={this.sendToParent}>
                      &nbsp;&nbsp;About Trauma</NavLink>
                  </li>
                  <li>
                    <NavLink to={'#'} style={{ cursor: "pointer" }} activeClassName="isSelectedActive" onClick={this.sendToParent}>
                      &nbsp;&nbsp;Find a Certified Trauma Therapist</NavLink>
                  </li>
                  <li>
                    <NavLink to={'/Learning-center'} style={{ cursor: "pointer" }} activeClassName="isSelectedActive" onClick={this.sendToParent}>
                      &nbsp;&nbsp;Trauma Training</NavLink>
                  </li>
                  <li>
                    <NavLink to={'/hft'} exact style={{ cursor: "pointer" }} activeClassName="isSelectedActive" onClick={this.sendToParent}>
                ...
                Auth.loggedIn() ? (
                  <div className="navbar-collapse-right-course col-md-2 p-0">
                    ...
                    <div className="navbar-collapse-right col-md-4">
                      ...
                      <NavLink to={"/login"} className="login">Login</NavLink> | <a href="#" className="forgot-password">Forgot Password</a>
                    </div>
                  )
              }
            </div>
